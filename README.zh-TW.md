...
| 檔案 | 適用平台 |
|---|---|
| `ZZZ-v2.0.1-win-x64.exe` | Windows x64 原生版本 |
| `ZZZ-v2.0.1-win-x86.exe` | Windows 10 x86 32 位元相容版；亦可在 Windows 10 on Arm 透過 x86 模擬執行 |
| `ZZZ-v2.0.1-win-arm64.exe` | Windows ARM64 原生版本 |
