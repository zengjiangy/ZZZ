...
| Datei | Plattform |
|---|---|
| `ZZZ-v2.2.1-win-x64.exe` | Native Windows-x64-Version |
| `ZZZ-v2.2.1-win-x86.exe` | 32-Bit-Version für Windows 10 x86 und Windows 10 on Arm per x86-Emulation |
| `ZZZ-v2.2.1-win-arm64.exe` | Native Windows-ARM64-Version |
