...
| 파일 | 플랫폼 |
|---|---|
| `ZZZ-v2.0.1-win-x64.exe` | Windows x64 네이티브 버전 |
| `ZZZ-v2.0.1-win-x86.exe` | Windows 10 x86 32비트 호환 버전(Windows 10 on Arm에서는 x86 에뮬레이션) |
| `ZZZ-v2.0.1-win-arm64.exe` | Windows ARM64 네이티브 버전 |
