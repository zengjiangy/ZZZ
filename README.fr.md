...
| Fichier | Plateforme |
|---|---|
| `ZZZ-v2.2.2-win-x64.exe` | Version native Windows x64 |
| `ZZZ-v2.2.2-win-x86.exe` | Version 32 bits pour Windows 10 x86 et Windows 10 on Arm via émulation x86 |
| `ZZZ-v2.2.2-win-arm64.exe` | Version native Windows ARM64 |
